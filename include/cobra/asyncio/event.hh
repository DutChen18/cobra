...
namespace cobra {
	template <class T> class event_handle_base {
	protected:
	...
	public:
		...
		T value() { return _result.get_value_move(); }
	};

	template <class T> class event_handle : public event_handle_base<T> {
	public:
	...
	template <> class event_handle<void> : public event_handle_base<void> {
	public:
	...
	template <class T, class Function> class event : public event_handle<T> {
	...
	public:
		...
		T await_resume() { return _handle.value(); }
	};
} // namespace cobra
