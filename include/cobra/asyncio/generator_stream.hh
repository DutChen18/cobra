...
namespace cobra {
	...
	class generator_stream : public basic_buffered_istream_impl<generator_stream<Generator>, typename Generator::result_type::value_type, typename Generator::result_type::traits_type> {
	public:
		using base = basic_buffered_istream_impl<generator_stream<Generator>, typename Generator::result_type::value_type, typename Generator::result_type::traits_type>;
